...
9. Длинный ответ без усечения разбивается по Unicode-безопасным границам на части до 4000 символов.
10. Части последовательно доставляются в Telegram и записываются в историю только после успешной доставки.
